...
<body>
    ...
    <div class="container my-3">
        ...
        <?php 
            $noResult = true;
            $query = $_GET["search"];
            $sql = "SELECT * FROM `kategori` WHERE MATCH(categorieName, categorieDesc) against('$query')";
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="image/card-'.$catId. '.jpg" class="card-img-top" alt="image for this food" width="249px" height="270px">
                        <div class="card-body">
